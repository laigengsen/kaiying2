<?php /*a:2:{s:71:"D:\phpstudy_pro\WWW\qiyezhan\application\admin\view\menage\product.html";i:1571279936;s:70:"D:\phpstudy_pro\WWW\qiyezhan\application\admin\view\public\header.html";i:1567693987;}*/ ?>
<head>
                ...
                success:function (res) {
					...
					for (i=0;i<res.length;i++){
                        ...
                        tr4.innerHTML='\t\t\t\t\t\t\t\t\t<td>\n' +
                            '\t\t\t\t\t\t\t\t\t\t<a href="#"><img src="<?php echo htmlentities($vo['productpicture']); ?>" width="100" height="50"></a>\n' +
                            '\t\t\t\t\t\t\t\t\t</td>';
                        tr4.children[0].children[0].attributes.src=res[i].productpicture;
                        // console.log(tr4.children[0].children[0].attributes.src=res[i].productpicture);
