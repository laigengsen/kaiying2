<?php /*a:2:{s:91:"D:\phpstudy_pro\WWW\qiyezhan2\qiyezhan\application\admin\view\friendship\friendshipadd.html";i:1571290340;s:80:"D:\phpstudy_pro\WWW\qiyezhan2\qiyezhan\application\admin\view\public\header.html";i:1567693988;}*/ ?>
<head>
	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form action="<?php echo url('friendship/friendshipaddsave'); ?>" method="post" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input name="link" type="text" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
