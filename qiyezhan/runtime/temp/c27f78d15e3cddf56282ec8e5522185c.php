<?php /*a:1:{s:84:"D:\phpstudy_pro\WWW\qiyezhan2\qiyezhan\application\user\view\index\aboutkaiying.html";i:1571555872;}*/ ?>
<!DOCTYPE html>
...
<link rel="stylesheet" href="/static/user/websiteDemo/css/style.css" />
    <link rel="stylesheet" href="/static/user/websiteDemo/css/aboutkaiying.css" />
...
<div class="product">
    <div class="productcate" style="padding-left: 50px;padding-top: 50px;color: black;border-bottom: 1px solid black;">
        <ul>
    ...
    <div class="products">
        ...
        <div style="padding: 30px;font-size: 20px"><?php echo htmlentities($aboutyouhua['title']); ?></div>
        <div><?php echo htmlentities($aboutyouhua['describ']); ?></div>
        </div>
</div>
