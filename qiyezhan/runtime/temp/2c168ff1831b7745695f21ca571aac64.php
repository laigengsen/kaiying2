...
<div class="product">
    <div class="products">
        <div><p style="font-size: 30px;color: black">新闻详情:</p></div>
        <div>
            <div>
                <p style="font-size: 30px">新闻名称:<span><?php echo htmlentities($newsdescrib['producttitle']); ?></span></p>

                <p>新闻关键字<span><?php echo htmlentities($newsdescrib['productkeycode']); ?></span></p>
                <div style="font-size: 35px;color: black;padding-top: 100px;"><?php echo htmlentities($newsdescrib['productdescrib']); ?></div>
            </div>
        </div>
    </div>
</div>
