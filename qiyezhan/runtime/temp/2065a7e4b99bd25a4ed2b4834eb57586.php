<?php /*a:1:{s:79:"D:\phpstudy_pro\WWW\qiyezhan2\qiyezhan\application\user\view\index\product.html";i:1571556069;}*/ ?>
<!DOCTYPE html>
...
<link rel="stylesheet" href="/static/user/websiteDemo/css/style.css" />
    <link rel="stylesheet" href="/static/user/websiteDemo/css/product.css" />
...
<div class="product">
    <div class="productcate" style="padding-left: 50px;padding-top: 50px;background-color: white;color: black">
        <ul>
    ...
    <div>
        <center>
        <p style="font-size: 40px;padding-top: 30px;margin-bottom: 10px;background-color: #01409d;color: white">高强度产品推荐</p>
        </center>
    </div>
    <div class="products">
        <div>
            <div>
                ...
                <a href="<?php echo url('Index/productdescrib',['id'=>$voproduct['id'],'cateid'=>$voproduct['parentid']]); ?>" style="text-decoration: none;float: left;padding-right: 10px">
