<?php /*a:2:{s:76:"D:\phpstudy_pro\WWW\qiyezhan\application\admin\view\menage\editcategory.html";i:1571153593;s:70:"D:\phpstudy_pro\WWW\qiyezhan\application\admin\view\public\header.html";i:1567693987;}*/ ?>
<head>
	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<form action="<?php echo url('menage/editcategorysave'); ?>" method="post" class="form-horizontal" role="form">

						<div class="form-group" >
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 名称 </label>

							<div class="col-sm-9">
								<input  name="id" type="hidden" value="<?php echo htmlentities($productcategory['id']); ?>">
								<input name="name" type="text" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" value="<?php echo htmlentities($productcategory['name']); ?>"/>
							</div>
						</div>
