<?php /*a:2:{s:73:"D:\phpstudy_pro\WWW\qiyezhan\application\webinfo\view\webinfo\youhua.html";i:1571103998;s:72:"D:\phpstudy_pro\WWW\qiyezhan\application\webinfo\view\public\header.html";i:1567693987;}*/ ?>
  <head>
...
<div class="row">
	<div class="col-xs-12">
		<!-- PAGE CONTENT BEGINS -->
		<form action="<?php echo url('system/systeminfosave'); ?>" method="post" class="form-horizontal" role="form">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> 公司名称: </label>

				<div class="col-sm-9">
					<input name="name" value="<?php echo htmlentities($youhua['companyname']); ?>" type="text" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input name="phone" value="<?php echo htmlentities($youhua['email']); ?>" type="text" id="form-field-1" placeholder="phone" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input name="mail" value="<?php echo htmlentities($youhua['person']); ?>" type="text" id="form-field-1" placeholder="mail" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input name="qq" value="<?php echo htmlentities($youhua['phone']); ?>" type="text" id="form-field-1" placeholder="Username" class="col-xs-10 col-sm-5" />
				</div>
			</div>
