<?php /*a:2:{s:82:"D:\phpstudy_pro\WWW\qiyezhan2\qiyezhan\application\admin\view\news\newsmenage.html";i:1571494244;s:80:"D:\phpstudy_pro\WWW\qiyezhan2\qiyezhan\application\admin\view\public\header.html";i:1567693988;}*/ ?>
<head>
				...
				<div class="col-md-8">
					<form class="form-inline">
						<div class="form-group">
							...
							<input name="name" type="text" class="form-control" placeholder="新闻名称..." value="<?php echo input('get.name'); ?>">
						</div>
									...
									<td style="text-align: center">
										<div class="hidden-sm hidden-xs btn-group">
											...
											<a href="<?php echo url('News/newsedit',['id'=>$vo['id'],'cateid'=>$vo['cateid']]); ?>" target="content">
												<button class="btn btn-xs btn-danger">编辑</button>
											</a>
