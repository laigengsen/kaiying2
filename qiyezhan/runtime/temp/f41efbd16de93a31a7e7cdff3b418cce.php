<?php /*a:1:{s:83:"D:\phpstudy_pro\WWW\qiyezhan2\qiyezhan\application\user\view\index\newskaiying.html";i:1572093359;}*/ ?>
<!DOCTYPE html>
...
<link rel="stylesheet" href="/static/user/websiteDemo/css/style.css" />
    <link rel="stylesheet" href="/static/user/websiteDemo/css/newskaiying.css" />
...
<div class="product">
    <div class="productcate" style="padding-left: 50px;padding-top: 50px;color: black;padding-bottom: 5px">
        <ul>
            ...
            <li style="font-size: 25px;margin-bottom: 30px;border-bottom: 1px solid black"><a href="#"><?php echo htmlentities($vo1['cate']); ?></a></li>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
    <div class="products">
        <center>
            <div style="color: #01409d;font-size: 35px">凯盈新闻动态</div>
        </center>
        ...
        <div class="newsbody">
            ...
            <div style="font-size: 20px;width: 100%"><a href="<?php echo url('Index/newsdescrib',['id'=>$vo2['id']]); ?>" style="color: black"><?php echo htmlentities($vo2['producttitle']); ?></a> </div>
            <div style="padding-left: 100px;padding-right: 100px;border-bottom: 3px dashed #01409d;width: 100%;margin-bottom: 20px"><?php echo htmlentities($vo2['productdescrib']); ?></div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </div>
    </div>
</div>
